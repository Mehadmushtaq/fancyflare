...
export const TermsAndConditions = () => {
  ...
  return (
    <Container maxWidth='lg' sx={{ padding: '3rem' }}>
      ...
      <Typography paragraph>Welcome to ayeshyefancyflare!</Typography>

      <Typography paragraph>
        These terms and conditions outline the rules and regulations for the use
        of Ayeshye Fancy Flare's Website, located at{' '}
        <a href='https://www.ayeshyefancyflare.com/'>
          https://www.ayeshyefancyflare.com/
        </a>
        .
      </Typography>
      ...
      <Typography paragraph>
        ...
        conditions. Do not continue to use ayeshyefancyflare if you do not agree
      ...
      <Typography paragraph>
        We employ the use of cookies. By accessing ayeshyefancyflare, you agreed
        to use cookies in agreement with the Ayeshye Fancy Flare's Privacy
        Policy.
      </Typography>
      ...
      <Typography paragraph>
        Unless otherwise stated, Ayeshye Fancy Flare and/or its licensors own
        the intellectual property rights for all material on ayeshyefancyflare.
        All intellectual property rights are reserved. You may access this from
        ayeshyefancyflare for your own personal use subjected to restrictions
        set in these terms and conditions.
      </Typography>

      <Typography paragraph>You must not:</Typography>
      <List>
        <ListItem>Republish material from ayeshyefancyflare</ListItem>
        <ListItem>
          Sell, rent or sub-license material from ayeshyefancyflare
        </ListItem>
        <ListItem>
          Reproduce, duplicate or copy material from ayeshyefancyflare
        </ListItem>
        <ListItem>Redistribute content from ayeshyefancyflare</ListItem>
      </List>

      <Typography paragraph>
        This Agreement shall begin on the date hereof. Our Terms and Conditions
        were created with the help of the{' '}
        <Link href='https://www.termsandconditionsgenerator.com/'>
      ...
      <Typography paragraph>
        ...
        Ayeshye Fancy Flare does not filter, edit, publish or review Comments
        prior to their presence on the website. Comments do not reflect the
        views and opinions of Ayeshye Fancy Flare,its agents and/or affiliates.
        Comments reflect the views and opinions of the person who post their
        views and opinions. To the extent permitted by applicable laws, Ayeshye
        Fancy Flare shall not be liable for the Comments or for any liability,
      ...
      <Typography paragraph>
        Ayeshye Fancy Flare reserves the right to monitor all Comments and to
      ...
      <Typography paragraph>
        You hereby grant Ayeshye Fancy Flare a non-exclusive license to use,
      ...
      <Typography paragraph>
        ...
        the hyperlink compensates the absence of Ayeshye Fancy Flare; and (d)
      ...
      <Typography paragraph>
        ...
        e-mail to Ayeshye Fancy Flare. Please include your name, your
      ...
      <Typography paragraph>
        No use of Ayeshye Fancy Flare's logo or other artwork will be allowed
